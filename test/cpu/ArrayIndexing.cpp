...
TEST_CASE("ArrayIndexing cpu", "utils")
{
    ...
    SECTION("indexing")
    {
        ...
        SECTION("indexing using TMP")
        {
            ...
            REQUIRE(IdxTmp::getAxisSizesVec() == cuvoxmap::uIdx3D{2, 3, 4});
            REQUIRE(IdxTmp::getIndexingInstance().getIndices() == cuvoxmap::uIdx3D{2, 3, 4});
...
TEST_CASE("ArrayInexingBlock cpu", "utils")
{
    ...
    SECTION("indexingblock tmp")
    {
        ...
        REQUIRE(IdxBlockTmp::getIndexingBlockInstance().getBlockDimIndexing().getIndices() == cuvoxmap::uIdx3D{2, 3, 4});
        REQUIRE(IdxBlockTmp::getIndexingBlockInstance().getGridDimIndexing().getIndices() == cuvoxmap::uIdx3D{5, 6, 7});
